...
- dfm_estimates:
  ...
  functions estimate_pca(), estimate_em() or estimate_ml().
...
- target_series:
  ...
  the name of the series of interest. By default, the first series is
  considered.
...
Banbura and Modugno (2010) - Maximum likelihood estimation of factor
